...
export default function DoctorAuth() {
  ...
  return (
    <div className="min-h-screen mt-[-65px] flex bg-gradient-to-br from-primary/20 to-secondary/20">
      <div className="hidden lg:flex lg:flex-1 bg-primary items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <p className="text-primary-foreground/80 text-lg">
            Join our network of healthcare professionals and revolutionize the way you manage your practice.
          </p>
        </div>
      </div>
              ...
              <TabsContent value="register">
                <Form {...registerForm}>
                  <form onSubmit={registerForm.handleSubmit(handleRegister)} className="space-y-4">
                    ...
                    <FormField
                      control={registerForm.control}
                      name="firstTimeDiscount.percentage"
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>First Time Discount (%)</FormLabel>
                          <FormControl>
                            <Input
                              type="number"
                              placeholder="e.g., 10"
                    ...
                    <FormField
                      control={registerForm.control}
                      name="firstTimeDiscount.maxAmount"
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Max Discount Amount (INR)</FormLabel>
                          <FormControl>
                            <Input
                              type="number"
                              placeholder="e.g., 500"
